...
class Membership(ActivityTracking):
    ...
    customer = models.ForeignKey("Customer", on_delete=models.CASCADE, blank=True, verbose_name=_("Customer"))
    plan = models.ForeignKey(Plan, on_delete=models.CASCADE, blank=True, verbose_name=_("Plan"))
