...
@register.inclusion_tag("customadmin/partials/input_daterange_bootstrap.html")
def input_daterange_bs(field, show_label=True, disabled=False):
    """Return HTML markup for a daterange input."""
...
def input_group_typeahead(field, icon_class=None, hidden=False):
    """Return HTML markup for a input group."""
    return {"field": field, "icon_class": icon_class, "hidden": hidden}
